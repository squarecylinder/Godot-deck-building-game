...
@export var char_stats: CharacterStats : set = set_new_stats
var new_stats : CharacterStats
...
func set_new_stats(value: CharacterStats) -> void:
	new_stats = value.create_instance()
